...
export const galleryImages: GalleryImage[] = [
  ...
  { src: '/assets/img/thanksgivingMenu.jpg', category: 'holiday', alt: 'Thanksgiving treats spread' },
  ...
  { src: '/assets/img/cookieBox.jpg', category: 'cookies', alt: 'Packaged cookie gift box' },
  ...
  { src: '/assets/img/box.jpg', category: 'holiday', alt: 'Holiday cookie gift box' },
